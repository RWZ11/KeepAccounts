...
const translations: Record<Language, Translations> = {
  "zh-CN": {
    ...
    currency: "结算币种", gemini_api_key: "Gemini AI Key",
    gemini_api_desc: "用于智能解析记账内容",
    set_api_key: "设置密钥", modify_api_key: "修改密钥", clear_api_key: "清除",
    api_key_title: "Gemini AI Key", api_key_placeholder: "输入你的Gemini API Key",
    api_key_help: "从 Google AI Studio 获取 API Key",
    save_api_key: "保存", api_key_saved: "密钥已保存",
